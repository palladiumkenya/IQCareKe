    ...
    public partial class LabResultPage : System.Web.UI.Page
    {
       ...
       /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           //PatientMasterVisitId = Convert.ToInt32(HttpContext.Current.Session["PatientMasterVisitId"]);
            ...
            if (!IsPostBack)
            {
                ...
                this.LabOrderId = Convert.ToInt32(HttpContext.Current.Session["PatientMasterVisitId"]);
                if (LabOrderId > 0)
                {
        ...
        private void PopulateRequest(int labOrderId)
        {
           ...
           // labOrderId = Convert.ToInt32(HttpContext.Current.Session["PatientMasterVisitId"]);
