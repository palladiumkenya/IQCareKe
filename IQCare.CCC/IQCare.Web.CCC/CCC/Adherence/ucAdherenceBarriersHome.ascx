...
<%@ Register TagPrefix="uc" TagName="tnHIVAwareness" Src="ucHIVAwareness.ascx" %>
<%@ Register TagPrefix="uc" TagName="tnUnderstanding" Src="ucUnderstanding.ascx" %>
<%@ Register TagPrefix="uc" TagName="tnDailyRoutine" Src="ucDailyRoutine.ascx" %>
