...
<script type="text/javascript">
    ...
    var UpdateRNSScreeningArray = new Array;
    ...
    function CheckifRNSScreeningHasValues() {
        ...
        $("#referralsandnetworks input[type=radio]:checked").each(function () {
            ...
            if (screeningValue > 0) {
                UpdateRNSScreeningArray.push({ 'Id': screeningCategory, 'value': screeningValue });
        ...
        $("#referralsandnetworks textarea").each(function () {
            ...
            UpdateRNSScreeningArray.push({ 'Id': categoryId, 'value': clinicalNotes});
        });
    }

    function addUpdateRNScreeningData(mastervisitid)
    {
        var error = 0;
        $("#referralsandnetworks input[type=radio]:checked").each(function () {
            var screeningValue = $(this).val();
    ...
    function GetReferralNetworksData() {
        var patientId =<%=PatientId%>;
        $.ajax({
            type: "POST",
