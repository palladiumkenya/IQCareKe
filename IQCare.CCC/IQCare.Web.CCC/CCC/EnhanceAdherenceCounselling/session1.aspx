...
<script type="text/javascript">
                ...
                success: function (response) {
                    ...
                    $.each(JSON.parse(response.d), function (index, value) {
                        ...
                        if ($("#session1tb" + this.NotesCategoryId).length > 0) {
                            var NotesCatId = this.NotesCategoryId;
                ...
                success: function (response) {
                    $.each(JSON.parse(response.d), function (index, value) {
                        if ($("#session1rb" + this.ScreeningCategoryId).length > 0) {
                            var ScreeningCatId = this.ScreeningCategoryId;
                            var ScreeningValId = this.ScreeningValueId;
                    ...
                    if(response.length > 0)    {
                        ...
                        if (this.PatientMasterVisitId > 0) {
                           ...
                           // window.location.href = window.location.href + "?visitId=" + this.PatientMasterVisitId;
                            ...
                            //+ "#EnhanceAdherence"
                           // window.location.replace("CCC/EnhanceAdherenceCounselling/EnhanceAdherenceHome.aspx?visitId=" + this.PatientMasterVisitId);
        ...
        if (currentStep == 1) {
            ...
            if (values != null) {
                if (values.length > 0) {
                    ...
                    toastr.info("Kindly fill the  Session 1 section with required data");
                    evt.preventDefault();
                    return false;
                }
                //   console.log(Answers);
    ...
    function CheckIfSession1DataHasValues() {
