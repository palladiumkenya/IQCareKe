...
{
    public partial class ucViralLoad : System.Web.UI.UserControl
    {
        ...
        protected void populateCtrls()
        {
            ...
            foreach (var value in questionsList)
            {
                ...
                if (notesValue > 0)
                {
                    ...
                    notesTb.ID = "endViralLoadTb" + value.ItemId.ToString();
                    notesTb.Rows = 3;
