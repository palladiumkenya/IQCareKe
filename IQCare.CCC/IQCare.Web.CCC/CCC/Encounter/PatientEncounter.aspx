...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="server">
    ...
    <div class="col-md-12 col-xs-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#healthscreening" aria-controls="healthscreening" role="tab" data-toggle="tab" id="loadHealthScreening"><i class="fa fa-stethoscope fa-lg" aria-hidden="true"></i> Assessments</a></li>
   ...
   <uc:ucExtruder runat="server" ID="ucExtruder" />
    ...
    <script type="text/javascript">
        ...
        $("#loadEnhanceAdherence").click(function () {
            $("#EnhanceAdherence .loading").show();
            $("#EnhanceAdherence").load("../UC/EnhanceAdherenceCounselling/EnhanceAdherenceHome.aspx");
