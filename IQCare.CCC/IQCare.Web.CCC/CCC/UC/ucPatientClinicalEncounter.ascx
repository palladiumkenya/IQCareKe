                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:DropDownList runat="server" AutoPostBack="False" CssClass="form-control input-sm" ID="EverBeenOnIpt" ClientIDMode="Static" onChange="EverBeenOnIptChange();" required="false" data-parsley-required="false">
                                                        <asp:ListItem Text="Select" Value="" Selected="True"></asp:ListItem>
                                                        <asp:ListItem Text="Yes" Value="True"></asp:ListItem>
                                                        <asp:ListItem Text="No" Value="False"></asp:ListItem>
                                                    </asp:DropDownList>
