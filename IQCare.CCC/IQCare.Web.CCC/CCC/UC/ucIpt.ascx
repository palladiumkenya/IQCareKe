    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12 form-group">
            <div class="col-md-4">
                <div class="col-md-12 form-group">
                    <div class="col-md-12">
                        <label class="control-label  pull-left text-primary">IPT Due Date</label>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="col-md-12 form-group">
                    <div class="col-md-12">
                        <label class="control-label  pull-left text-primary">IPT Date Collected</label>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <asp:DropDownList runat="server" CssClass="form-control input-sm" ID="weight" ClientIDMode="Static" />
                </div>
            </div>
        </div>
        <div class="col-md-12 form-group">
