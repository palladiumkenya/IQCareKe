...
namespace IQCare.Web.CCC.UC.Adherence
{
    ...
    {
        public int PCId, PatientId, PatientMasterVisitId, userId, NotesId, screenTypeId;
        ...
        protected void populateQuestions()
        {
            ...
            List<LookupItemView> questionsList = lookUp.getQuestions("PsychosocialCircumstances");
            int i = 0;
