<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPatientDetails.ascx.cs" Inherits="IQCare.Web.CCC.UC.ucPatientDetails" %>
        ...
        <div id="callout-labels-inline-block" class="col-md-12 well well-sm bs-callout bs-callout-primary" style="padding-bottom:1%">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                    <div class="col-md-12">
                        <div class="col-md-2" style="border-bottom:1px solid blue;margin-bottom:1%;margin-right:1%"><asp:Label runat="server" ClientIDMode="Static" id="lblLastName" name="lblnm" class="text-info pull-left">lname</asp:Label></div>
                        ...
                        <div class="col-md-1" style="border-bottom:1px solid blue;margin-bottom:1%;margin-right:1%"><asp:Label runat="server" ClientIDMode="Static" id="lblAge" class="text-info pull-left">Age years</asp:Label></div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-1"><small class="text-success"><i>Age</i></small></div>
