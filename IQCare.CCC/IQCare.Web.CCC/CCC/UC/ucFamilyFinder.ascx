<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucFamilyFinder.ascx.cs" Inherits="IQCare.Web.CCC.UC.ucFamilyFinder" %>

  <div class="col-md-12 col-xs-12 col-sm-12 " id="SearchPeopleFamily">
          ...
          $(document).ready(function () {
              ...
              $("#btnFindPatient").click(function (e) {
                  ...
                  table = $("#tblFindPatient").dataTable({
                      ...
                      "info": true,
                      "bDestroy": true,
                      "sAjaxSource": "../WebService/PatientService.asmx/GetPatientSearchList",
