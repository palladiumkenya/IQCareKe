...
<!--  
	Transformations for result print out
	Created: February 23, 2016 by Joseph Njung'e
-->
...
return(sDate.substr(8,2) + "-" + sMonth + "-" + sDate.substr(0,4));
    ...
    <xsl:template match="/" >
        <head>
            ...
            <script LANGUAGE="Javascript">
                ...
                function PrintMe(text){if (confirm("Print Lab Result?")){   window.print();     }  
            </script>
        </head>
	...
	<xsl:template name="items">
		...
		<tr> 
			<td style="white-space:nowrap"><b>Lab Name</b></td>		
			<td  width="50%"><b>Test notes</b></td>		
			<td style="white-space:nowrap"><b>Status</b></td>
			<td style="white-space:nowrap" ><b>Result By</b></td>
