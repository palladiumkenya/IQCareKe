			...
			BEGIN
				...
				BEGIN TRY
					BEGIN TRANSACTION
						...
						--Default all persons to new
						SET @ARTStartDate=( SELECT top 1 convert(varchar(10),ARTTransferInDate, 126) FROM dtl_PatientHivPrevCareIE WHERE Ptn_pk=@ptn_pk And ARTTransferInDate Is Not Null);
