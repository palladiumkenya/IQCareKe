...
[StrongPassFlag],[ExpPwdFlag],[ExpPwdDays],[Frequency])                           
...
@DateFormat,@PepFarStartDate,0,@SystemId,@Preferred,@Paperless, @UserID,getdate(),@FacilityAddress,@FacilityTel,@FacilityCell,@FacilityFax,@FacilityEmail,                              
 @FacilityURL,@FacilityFooter,@FacilityTemplate,@FacilityLogo,@StrongPassword,@ExpirePaswordFlag,@ExpirePaswordDays,@DosageFrequency)                          
