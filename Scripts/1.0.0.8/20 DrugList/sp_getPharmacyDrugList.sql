...
/***** Object:  StoredProcedure [dbo].[sp_getPharmacyDrugList]    Script Date: 1/16/2019 11:55:02 AM *****/
SET ANSI_NULLS ON
GO
...
Set Nocount On;
	...
	-- ///////////////////////////////////////////////////////////////////////////////////////
	SET @pmscm = (SELECT top 1 f.PaperLess FROM mst_Facility f WHERE f.DeleteFlag=0)
