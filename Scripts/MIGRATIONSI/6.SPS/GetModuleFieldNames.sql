...
ALTER procedure [dbo].[Pr_Clinical_GetModuleFieldNames_Constella]                              
(                              
 @patientid int,                                 
 @moduleId int                            
)                              
...
IF NOT   EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Pr_Clinical_GetModuleFieldNames_Constella]') AND type in (N'P', N'PC'))
BEGIN
