IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_PartnerNotificationRegister]'))
DROP VIEW [dbo].[vw_PartnerNotificationRegister]
GO


/****** Object:  View [dbo].[vw_PartnerNotificationRegister]    Script Date: 06/21/2018 16:31:52 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vw_PartnerNotificationRegister]
AS
