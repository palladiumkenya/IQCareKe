...
namespace Application.Presentation
   ...
   public  enum MenuChoice
    ...
    public  class GblIQCare
    {
        ...
        public GblIQCare()
        {
            AppVersion = "Ver 1.0.0.6 Kenya HMIS Patch2";
            ReleaseDate = "22-Jun-2018";
            VersionName = "Kenya HMIS Ver 1.0.0.6 Patch2";
            DbVersion = "Ver 1.0.0.6 Kenya HMIS";
        }
        ...
        public static string AppVersion = "Ver 1.0.0.6 Kenya HMIS Patch2";
        public static string DbVersion = "Ver 1.0.0.6 Kenya HMIS";
        public static string ReleaseDate = "22-Jun-2018";
        public static string VersionName = "Kenya HMIS Ver 1.0.0.6 Patch2";
        #endregion
