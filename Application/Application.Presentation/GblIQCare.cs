...
namespace Application.Presentation
   ...
   public  enum MenuChoice
    ...
    public  class GblIQCare
    {
        ...
        public GblIQCare()
        {
            AppVersion = "Ver 2.2.2 Kenya HMIS";
            ReleaseDate = "26-Feb-2020";
            VersionName = "Kenya HMIS Ver 2.2.2";
            DbVersion = "Ver 2.2.2 Kenya HMIS";
        }
        ...
        public static string AppVersion = "Ver 2.2.2 Kenya HMIS";
        public static string DbVersion = "Ver 2.2.2 Kenya HMIS";
        public static string ReleaseDate = "26-Feb-2020";
        public static string VersionName = "Kenya HMIS Ver 2.2.2";
        #endregion
