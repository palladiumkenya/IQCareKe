...
namespace Application.Presentation
   ...
   public  enum MenuChoice
    ...
    public  class GblIQCare
    {
        ...
        public GblIQCare()
        {
            AppVersion = "Ver 2.0.1 BETA Kenya HMIS";
            ReleaseDate = "20-May-2019";
            VersionName = "Kenya HMIS Ver 2.0.1";
            DbVersion = "Ver 2.0.1 Kenya HMIS";
        }
        ...
        public static string AppVersion = "Ver 2.0.1 BETA Kenya HMIS";
        public static string DbVersion = "Ver 2.0.1 Kenya HMIS";
        public static string ReleaseDate = "20-May-2019";
        public static string VersionName = "Kenya HMIS Ver 2.0.1";
        #endregion
