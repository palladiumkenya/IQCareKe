<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PayBillExempt.ascx.cs"
    Inherits="IQCare.Web.Billing.PayBillExempt" %>
...
<asp:UpdatePanel ID="notificationPanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>            
        ...
        <ajaxToolkit:ModalPopupExtender ID="notifyPopupExtender" runat="server" TargetControlID="btn"
            ...
            BehaviorID="PYCPmpeBID01" PopupDragHandleControlID="pnPopup_Title" Enabled="True"
            DynamicServicePath="">
...
<asp:UpdatePanel runat="server" ID="upPayPanel" UpdateMode="Conditional" ChildrenAsTriggers="true">
    <ContentTemplate>
        ...
        <asp:Panel ID="panelCompute" runat="server" Style="display: block; width: 480px;"
            DefaultButton="buttonCompute">
            <table width="100%">
                <tr>
                    <td valign="top" style="width: 75%">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td title="Exemption Reason">
                                    <asp:DropDownList ID="ddlExemption" runat="server" Width="240px" ViewStateMode="Enabled"
                                        >
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="textReferenceNo" runat="server" Width="180px" AutoComplete="Off"
                    ...
                    <td align="center" width="25%" style="height: 100%">
                        <table width="100%" style="height: 100%">
                            <tr>
                                <td valign="middle">
                                    <asp:Button ID="buttonCompute" runat="server" Text="Validate" Height="70px" Style="white-space: nowrap"
                                        Font-Bold="True" ForeColor="InfoText" OnClick="buttonCompute_Click" Width="100%"
                                        Enabled="True" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="buttonStepBack" runat="server" Text="Cancel" Height="70px" Style="white-space: nowrap"
                                        Font-Bold="True" ForeColor="InfoText" Width="100%" Enabled="True" CausesValidation="False"
                                        OnClick="buttonStepBack_Click" UseSubmitBehavior="False" />
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <asp:Panel ID="panelFinish" runat="server" Style="width: 480px;" Visible="false"
