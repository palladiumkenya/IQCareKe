            ...
            if (e.CommandName.Equals("AddItem"))
            {
                try
                {
                    ...
                    IssuableItem newItem = new IssuableItem()
                    {
                        ...
                        IssuedById = this.UserID,
                        IssuedQuantity = int.Parse(txtNewQuantity.Text),
                        SellingPrice = decimal.Parse(lblNewUnitPrice.Text),
                        Paid = false,
                        Received = true,
                        Active = true,
                        ModuleId = moduleID,
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        IssuableItem itemNew = new IssuableItem()
                        {
                            ...
                            IssuedQuantity = int.Parse(txtUpdateQuantity.Text),
                            CostCenter = costCenterName,
                            ModuleId = moduleID,
                            SellingPrice = decimal.Parse(lblUpdateUnitPrice.Text),
