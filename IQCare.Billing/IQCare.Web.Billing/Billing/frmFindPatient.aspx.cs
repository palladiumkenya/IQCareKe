    ...
    public partial class FindPatient : System.Web.UI.Page
    {
        ...
        void FindPatient_SelectedPatientChanged(object sender, CommandEventArgs e)
        {
            ...
            if (this.LocationId == Convert.ToInt32(base.Session["AppLocationId"]))
            {
                ...
                CurrentSession.Current.SetCurrentPatient(this.PatientId);
                this.Redirect();
            }
            else
            {
        ...
        void FindPatient_CancelFind(object sender, EventArgs e)
        {
            ...
            else if (formName == "QuickPanel")
            {

                Response.Redirect("~/Billing/Home.aspx");
        ...
        void Redirect()
        {
            ...
            {
                theUrl = string.Format("{0}?PatientId={1}&mode=billing", "~/Billing/frmBilling_BillingPanel.aspx", PatientId);
                Response.Redirect(theUrl);
