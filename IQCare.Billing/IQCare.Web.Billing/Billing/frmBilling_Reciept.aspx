<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmBilling_Reciept.aspx.cs"
    Inherits="IQCare.Web.Billing.Reciept" %>
...
<head runat="server">
    <title>Transaction Receipt Print Out</title>
    <style type="text/css">
        body
        {
    ...
    <asp:Panel ID="divError" runat="server" Style="padding: 5px" CssClass="background-color: #FFFFC0; border: solid 1px #C00000"
        ...
        <div>
                <asp:Label ID="lblError" runat="server" Style="font-weight: bold; color: #800000"
                    Text="Error Occurred when fetching the receipt"></asp:Label>
            </div>
    </asp:Panel>
    <div>
