...
If Not Exists(Select 1 From LookupItem where Name='VIA/VILI') Begin INSERT INTO LookupItem (Name, DisplayName, DeleteFlag) VALUES ('VIA/VILI','VIA/VILI',0); End
...
If Not Exists(Select 1 From LookupMasterItem where LookupMasterId=(SELECT TOP 1 Id FROM LookupMaster WHERE Name='CacxMethod') and LookupItemId=(SELECT TOP 1 Id FROM LookupItem WHERE Name='VIA/VILI')) Begin Insert Into LookupMasterItem(LookupMasterId ,LookupItemId,DisplayName, OrdRank)VALUES((SELECT TOP 1 Id FROM LookupMaster WHERE Name='CacxMethod'),(SELECT TOP 1 Id FROM LookupItem WHERE Name='VIA/VILI'),'VIA/VILI',3); end 
