/****** Object:  View [dbo].[Api_PatientsView]    Script Date: 6/27/2019 9:08:41 PM ******/
SET ANSI_NULLS ON
GO
...
LEFT JOIN dbo.PatientIdentifier AS pni ON pni.PatientId = PT.Id and PE.Id = pni.PatientEnrollmentId
