...
/****** Object:  View [dbo].[HEI Register]    Script Date: 02/15/2019 09:38:59 ******/
SET ANSI_NULLS ON
GO
...
SELECT        pe.EnrollmentDate, pid.IdentifierValue AS HEIID, p.Id AS PatientID,p.Ptn_pk,p.FacilityId FacilityCode,
                             NULL AS EntryPoint,p.DateOfBirth,datediff(month,p.DateOfBirth,pe.EnrollmentDate) as AgeEnrollment,he.BirthWeight,
                             (SELECT        Name
                             ...
                             (SELECT        Name
                               ...
                               WHERE        (Id = he.MotherPMTCTDrugsId)) AS PMTCTARVSMother, 
							   (SELECT        Name
                               FROM            dbo.LookupItem AS LookupItem_1
                               WHERE        (Id = he.MotherPMTCTRegimenId)) AS [MotherARTRegimenAtEnrollment], (SELECT        Name
                               FROM            dbo.LookupItem AS LookupItem_1
                               WHERE        (Id = he.[MotherArtInfantEnrolRegimenId]))  AS PMTCTProphylaxisInfant, DATEDIFF(ww, mp.DOB, pl6.OrderedByDate) AS FirstPCR_AgeInWeeks, pl6.OrderedByDate AS FirstPCR_SampleTaken, 
                         ...
                         feedlook68Wks.ItemName AS Feeding_6_8Weeks, CASE WHEN pharm8nvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_6_8Weeks, CASE WHEN pharm8ctx.ptn_pharmacy_pk IS NOT NULL 
                         THEN 'Yes' ELSE NULL END AS GivenCTX_6_8Weeks, feedlook10Wks.ItemName AS Feeding_10Weeks, CASE WHEN pharm10nvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_10Weeks, 
                         CASE WHEN pharm10ctx.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenCTX_10Weeks, feedlook14Wks.ItemName AS Feeding_14Weeks, CASE WHEN pharm14nvp.ptn_pharmacy_pk IS NOT NULL 
                         THEN 'Yes' ELSE NULL END AS GivenNVP_14Weeks, CASE WHEN pharm14ctx.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenCTX_14Weeks, feedlook6Mons.ItemName AS Feeding_6_Months, 
                         CASE WHEN pharm6Monsnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_6Months, CASE WHEN pharm6Monsctx.ptn_pharmacy_pk IS NOT NULL 
                         THEN 'Yes' ELSE NULL END AS GivenCTX_6Months, DATEDIFF(mm, p.DateOfBirth, pl6Mons.OrderedByDate) AS Months_6PCR_AgeInMonths, pl6Mons.OrderedByDate AS SecondPCR_SampleTaken, 
                         ...
                         feedlook9Mons.ItemName AS Feeding_9_Months, CASE WHEN pharm9Monsnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_9Months, CASE WHEN pharm9Monsctx.ptn_pharmacy_pk IS NOT NULL 
                         THEN 'Yes' ELSE NULL END AS GivenCTX_9Months, feedlook12Mons.ItemName AS Feeding_12_Months, CASE WHEN pharm12Monsnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_12Months, 
                         CASE WHEN pharm12Monsctx.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenCTX_12Months, DATEDIFF(mm, p.DateOfBirth, pl12Mons.OrderedByDate) AS Months_12PCR_AgeInMonths, 
                         ...
                         feedlook15Mons.ItemName AS Feeding_15_Months, CASE WHEN pharm15Monsnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_15Months, 
                         CASE WHEN pharm15Monsctx.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenCTX_15Months, feedlookConfirm.ItemName AS Feeding_Confirm_Months, 
                         CASE WHEN pharmConfirmnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_Confirm, CASE WHEN pharmConfirmctx.ptn_pharmacy_pk IS NOT NULL 
                         THEN 'Yes' ELSE NULL END AS GivenCTX_Confirm, DATEDIFF(mm, p.DateOfBirth, plConfirm.OrderedByDate) AS Months_ConfirmPCR_AgeInMonths, plConfirm.OrderedByDate AS ConfirmPCR_SampleTaken, 
                         ...
                         feedlook1824mnths.ItemName AS Feeding_1824_Months, CASE WHEN pharm1824mnthsnvp.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenNVP_1824mnths, 
                         CASE WHEN pharm1824mnthsctx.ptn_pharmacy_pk IS NOT NULL THEN 'Yes' ELSE NULL END AS GivenCTX_1824mnths, DATEDIFF(mm, p.DateOfBirth, plConfirm.OrderedByDate) AS Months_Antibody1824_AgeInMonths, 
                         CASE WHEN pl1824mnths.TestResults1 = '0.00' THEN 'Negative' WHEN pl1824mnths.TestResults1 = '1.00' THEN 'Positive' ELSE pl1824mnths.TestResults1 END AS Antibody1824mnths_Results, 
						  (SELECT        Name
                               FROM            dbo.LookupItem AS LookupItem_1
                               WHERE        (Id = he.[Outcome24MonthId])) AS Outcome24Months, 
