...
SELECT  distinct a.Ptn_Pk,b.Id, a.FirstName, a.MiddleName, a.LastName, a.DOB, a.Sex, a.MaritalStatus, a.Phone, 
        d.VisitDate, h.VisitType, h.IdentifierValue AS ANC_Number, h.Name AS ServiceArea, b.FacilityId, h.VisitNumber, 
        i.Parity, i.Gravidae, a.Landmark, a.VillageName, i.LMP, i.EDD EDC, k.Weight, k.Height, 
        k.BPSystolic, k.BPDiastolic, k.Muac,BAC.BreastExamDone BreastExam,counselledOn AS CounselledOn,NULL HB,BAC.TreatedForSyphillis AS [RPR/VDRL],'' AS [RPR/VDRL Results],BAC.TreatedForSyphillis AS [Syphilis Treated],BAC.HivStatusBeforeAnc [HIV status before 1st ANC],
