if not Exists(select * from LookupMaster where Name like 'AppointmentGiven')
BEGIN
insert into LookupMaster (Name,DisplayName,DeleteFlag)
values('AppointmentGiven','AppointmentGiven','0')
END
