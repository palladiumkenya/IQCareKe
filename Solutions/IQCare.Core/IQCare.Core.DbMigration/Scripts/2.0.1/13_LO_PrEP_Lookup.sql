...
-- LookupMasterItem
If Not Exists(Select 1 From LookupMasterItem where LookupMasterId=(SELECT TOP 1 Id FROM LookupMaster WHERE Name='PrEP_Status') and LookupItemId=(SELECT TOP 1 Id FROM LookupItem WHERE Name='Start')) Begin Insert Into LookupMasterItem(LookupMasterId ,LookupItemId,DisplayName, OrdRank)VALUES((SELECT TOP 1 Id FROM LookupMaster WHERE Name='PrEP_Status'),(SELECT TOP 1 Id FROM LookupItem WHERE Name='Start'),'Start',1); end
