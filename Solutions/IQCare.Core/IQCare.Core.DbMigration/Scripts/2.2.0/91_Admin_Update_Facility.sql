...
GO
/****** Object:  StoredProcedure [dbo].[pr_Admin_UpdateFacility_Constella]    Script Date: 25/02/2020 12:00:08 ******/
SET ANSI_NULLS ON
GO
...
,[FacilityLogo] = @FacilityLogo,[StrongPassFlag]=@StrongPassword,[ExpPwdFlag]=@ExpirePaswordFlag,[ExpPwdDays]=@ExpirePaswordDays,[SystemQueue]=@SystemQueue,
[PartialDispense]=@PartialDispense
