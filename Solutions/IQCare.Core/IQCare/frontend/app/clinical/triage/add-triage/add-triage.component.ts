  ...
  public BuildVitalsFormGroup(): FormGroup {
    ...
    return this._formBuilder.group({
        ...
        bpDiastolic: new FormControl('', [Validators.required,
            Validators.max(this.VitalsValidation.DiastolicaBP),
            Validators.min(0),
            Validators.pattern(this.VitalsValidation.NumberValidationPattern)]),
        bpSystolic: new FormControl('', [Validators.required,
            Validators.max(this.VitalsValidation.SystolicBP),
            Validators.min(0),
            Validators.pattern(this.VitalsValidation.NumberValidationPattern)]),
      ...
      (result) => {
          ...
          this.triageService.AddPatientVitalInfo(patientVitalCommand).subscribe(
              res => {
                  ...
                  console.log(res);
                  this.snotifyService.success('Patient vitals information added sucessfully', 'Triage', this.notificationService.getConfig());
