...
{ 
    ...
    {
    IPatientEntryPointManager _mgr = (IPatientEntryPointManager)ObjectFactory.CreateInstance("BusinessProcess.Records.Enrollment.BPatientEntryPoint, BusinessProcess.Records");
