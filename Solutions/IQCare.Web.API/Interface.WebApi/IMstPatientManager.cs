...
namespace Interface.WebApi
{
    ...
    {
        int AddMstPatient(string firstName, string middleName, string lastName, DateTime registrationDate, DateTime dob, string dobPrecision, string phone, string gender, string landmark, 
            string maritalStatus, string htsId, string moduleId, string cardSerial, string village, string ward, string subcounty, string heiId, string Address,string card_issuing_facility,string hts_number_issuing_facility);
