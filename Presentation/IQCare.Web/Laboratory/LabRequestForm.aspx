  ...
  <style type="text/css">
    ...
    <div  class="row" style="padding: 8px;">
          ...
          <div class="panel panel-default">
               <div class="panel-heading"><span class="fa fa-barcode fa-1x text-info pull-left"><strong> Lab Request Form </strong></span><br /></div>
                                                                    ...
                                                                    <span style='display: <%= sEdit %>; white-space: nowrap'>
                                                                        <asp:Button ID="buttonRemove" runat="server" CausesValidation="false" CommandName="Remove"
                                                                            Text="Remove" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "TestId") %>'
                                                                             CssClass="btn btn-danger pull-right"></asp:Button></span></div>
                            ...
                            <tbody>
                                ...
                                <tr style="display:none">
                                    <td class="pad18" valign="middle" class="">
                                        ...
                                        <span style='display: <%= sEdit %>'>
                                            ...
                                            <asp:ImageButton runat="Server" ID="ImageButton2" Height="22" Style="hspace: 3; width: 22;
                                ...
                                <tr class=" well well-sm">
                                    ...
                                    <td class="pad18 pull-right" style="width: 50%; white-space: nowrap">
                                        <div class="pull-left"><label class="required" class="control-label pull-left" for="LabOrderedbyDate"> *Order Date:</label></div>
                                        <span style='display: <%= sEdit %>'>
                                           <div class="col-md-5"><asp:TextBox ID="txtlaborderedbydate" CssClass="form-control" MaxLength="12" runat="server"></asp:TextBox></div> 
                                           <div class="pull-left">
          ...
          <%--  <asp:UpdatePanel ID="divNotifyComponent" runat="server">
                <ContentTemplate>
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="notifyPopupExtender" runat="server" TargetControlID="btn"
                        ...
                        BehaviorID="request_syspaperles" PopupDragHandleControlID="pnPopup_Title" Enabled="True"
                        DynamicServicePath="">
                    </ajaxToolkit:ModalPopupExtender>
                </ContentTemplate>
                <Triggers>
