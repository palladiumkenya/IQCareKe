...
<asp:Content ID="Content1" ContentPlaceHolderID="IQCareContentPlaceHolder" runat="Server">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><span class="fa fa-th fa-2x pull-left text-info"><strong>ART Therapy</strong></span><br />
            </div>
                            ...
                            <tbody>
                                <tr>
                                    <td class="border whitebg formcenter pad5">
                                        <div class="col-md-12">
                                            <label id="Label2" class="control-label required pull-left">Date Medically Eligible:</label></div>
                                        <div class="col-md-4" style="padding-right: 0%">
                                            <input id="txtdateEligible" class="form-control" runat="server" maxlength="11" size="10" name="txtarttransdate" /></div>
                                    ...
                                    <td class="border whitebg formcenter pad5">
                                        <div class="col-md-12">
                                            <label class="control-label required pull-left">Eligible Through:</label></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="border whitebg formcenter pad5" style="width: 50%">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 pull-left">
                                                                <div class="col-md-12">
                                                                    <label id="control-label pull-left">CD4:</label></div>
                                                                <div class="col-md-6 pull-left">
                                                                    <asp:TextBox ID="txtCD4" CssClass="form-control" runat="server"></asp:TextBox></div>
                                                            </div>

                                                            <div class="col-md-6 pull-left">
                                                                <div class="col-md-12">
                                                                    <label id="Label4" class="control-label pull-left">CD4 %:</label></div>
                                                                <div class="col-md-6 pull-left">
                                                                    <asp:TextBox ID="txtCD4percent" CssClass="form-control" runat="server"></asp:TextBox></div>
                                                            </div>
                                                    ...
                                                    <td class="border whitebg formcenter pad5" style="width: 25%">
                                                        <div id="divOtherEligibility">
                                                            <div class="col-md-12  pull-left ">
                                                                <label id="labelOthers" class="control-label pull-left" for="textOtherEligibility">Other: </label>
                                                            </div>
                                                            <div class="col-md-10 pull-left">
                                                                <asp:TextBox ID="textOtherEligibility" CssClass="form-control" runat="server" MaxLength="100" /></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="border whitebg formcenter pad5">
                                    ...
                                    <div class="col-md-3">
                                        <div class="col-md-12">
                                            <label class="control-label pull-left">Cohort Month:</label></div>
                                        <div class="col-md-4">
                                            <input id="txtcohortmnth" class="form-control" size="10" name="CohortMonth" runat="server" readonly="readonly" /></div>
                                    </div>
                                    <div class="col-md-3" style="padding-left: 0%">
                                        <div class="col-md-12">
                                            <label class="control-label pull-left">Cohort Year:</label></div>
                                        <div class="col-md-4 pull-left" style="padding-left: 0%">
                                            <input id="txtcohortyear" class="form-control" size="10" name="CohortYear" runat="server" readonly="readonly" /></div>
                                    </div>
                                        </div>
                                </td>
                                <td ></td>
                            ...
                            <tr>
                                <td class="border whitebg formcenter pad5">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                <label id="lblrARTdate" class="control-label pull-left">Start ART 1st Line Regimen Date:</label></div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-1 pull-left" style="padding-left: 0%">
                                                <asp:Button ID="btnanotherRegimen" CssClass="btn btn-info" runat="server" Text="..." OnClick="btnTransRegimen_Click" /></div>
                                            <div class="col-md-4 pull-left" style="padding-right: 0%">
                                                <input id="txtanotherregimen" class="form-control" size="16" name="anotherregimen" readonly="readonly" runat="server" /></div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="border whitebg formcenter pad5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">Weight (Kgs): </label>
                                            </div>
                                            <div class="pull-left">
                                                <input id="txtanotherwght" class="form-control" size="6" maxlength="3" name="anotherwght" runat="server" /></div>
                                        </div>

                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">Height (cm) :</label></div>
                                            <div class="pull-left">
                                                <input id="txtanotherheight" class="form-control" size="6" maxlength="3" name="anotherheight" runat="server" /></div>
                                        </div>

                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">BMI :</label></div>
                                            <div class="pull-left">
                                                <input id="txtanotherbmi" class="form-control" size="6" name="anotherbmi" runat="server" readonly="readonly" /></div>
                                        </div>

                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">MUAC :</label></div>
                                            <div class="pull-left">
                                                <asp:TextBox ID="textAnotherMuac" class="form-control" runat="server" AutoComplete="Off"></asp:TextBox></div>
                                        </div>

                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <ajaxToolkit:FilteredTextBoxExtender ID="ftemuac" runat="server" TargetControlID="textAnotherMuac"
                                                    FilterType="Numbers, Custom" ValidChars="." />
                                            </div>
                                            <div class="pull-left">
                                                <asp:RangeValidator ID="rgMuac" runat="server" ControlToValidate="textAnotherMuac"
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="pull-left">
                                                <asp:DropDownList ID="lstanotherClinicalStage" class="form-control" runat="server"></asp:DropDownList></div>
                                        </div>
                            ...
                            <tr>
                                <td class="border whitebg formcenter pad5">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                <label id="lblthisregi" class=" control-label pull-left">Start ART 1st Line Regimen Date:</label></div>
                                            <div class="col-md-4" style="padding-right: 0%">
                            ...
                            <tr>
                                <td class="border whitebg formcenter pad5">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">Weight (Kgs):</label></div>
                                            <div class="pull-left">
                                                <input id="txtthiswght" class="form-control" size="6" name="thisweight" runat="server" readonly="readonly" /></div>
                                        </div>
                                        <!-- .col-md-2-->
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">Height (cm):</label></div>
                                            <div class="pull-left">
                                                <input id="txtthisheight" class="form-control" size="6" name="thisheight" runat="server" readonly="readonly" /></div>
                                        </div>
                                        <!-- .col-md-2-->
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">BMI :</label></div>
                                            <div class="pull-left">
                                                <input id="txtthisbmi" class="form-control" size="6" name="thisbmi" runat="server" readonly="readonly" /></div>
                                        </div>
                                        <!-- .col-md-2-->
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">MUAC :</label></div>
                                            <div class="pull-left">
                                                <asp:TextBox ID="textMuacThis" CssClass="form-control" runat="server" AutoComplete="Off" ReadOnly="true"></asp:TextBox></div>
                                        </div>
                                        <!-- .col-md-2-->
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <label class="control-label pull-left">WHO Stage:</label></div>
                                            <div class="pull-left">
                                                <asp:DropDownList ID="lstthisClinicalStage" CssClass="form-control" runat="server" Enabled="false">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <!-- .col-md-2-->
